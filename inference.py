...
while True:
 ...
 # Define the dimensions of the box
	...
	# Resize the frame to fit the box
	resized_frame = cv2.resize(frm, (box_width, box_height))

	# Update the window with the resized frame, starting from the top-left corner
	window[:box_height, :box_width, :] = resized_frame
